d3.csv("https://raw.githubusercontent.com/Siyuan-Yu/IVFinal/main/pair.csv").then(function (data) {
    ...
    PieReceiveName1 = "Indonesian";
    PieReceiveName2 = "Sanskrit";
    ...
    function getData() {
        ...
        var dataOneLine = data.filter(d => d.Recipient_name === PieReceiveName1 && d.Donor_name === PieReceiveName2).map(d => [d.Adjectivizer_or_Adverbializer, d.Particle, d.Case_Suffixes, d.Noun, d.Nominalizer, d.Number_and_Numeral_Representations, d.Valency_Changing_Verbal_Suffixes, d.Verb]);
    ...
    var color = d3.scaleOrdinal(["#98abc5", "#8a89a6", "#7b6888", "#6b486b", "#a05d56", "#d0743c", "#ff8c00", '#7cd6cf', '#76da91']);
